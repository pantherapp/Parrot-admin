      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            if (isNew) {
              _Object$assign(data, (_Object$assign2 = {}, _Object$assign2[timestampFieldNames.createdAt] = new Date(), _Object$assign2));
            }

            data = _Object$assign(previous, (_Object$assign3 = {}, _Object$assign3[timestampFieldNames.updatedAt] = new Date(), _Object$assign3), data);
            ...
            _context2.next = 6;
            return firebase.firestore().doc(resourcePath + '/' + data.id).set(firebaseSaveFilter(data));
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 3;
            return firebase.firestore().doc(resourcePath + '/' + id)['delete']();
        ...
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            return ids.map(function (id) {
              return firebase.firestore().doc(resourceName + '/' + id)['delete']();
            });
...
var getOne = function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee5(params, resourceName, resourceData) {
    var result, data;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.next = 3;
            return firebase.firestore().collection(resourceName).doc(params.id).get();
...
var getList = function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee6(params, resourceName, resourceData) {
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            values = [];
            _context6.next = 4;
            return firebase.firestore().collection(resourceName).get();

          case 4:
            snapshots = _context6.sent;
            _iterator = snapshots.docs, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _getIterator(_iterator);
          ...
          case 22:
            ...
            if (params.filter) {
              values = values.filter(function (item) {
                ...
                for (var _iterator2 = _Object$keys(params.filter), _isArray2 = Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : _getIterator(_iterator2);;) {
                  var _ref8;
...
var getMany = function () {
  var _ref9 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee7(params, resourceName, resourceData) {
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            ...
            _iterator3 = params.ids, _isArray3 = Array.isArray(_iterator3), _i3 = 0, _iterator3 = _isArray3 ? _iterator3 : _getIterator(_iterator3);
...
var getManyReference = function () {
  var _ref12 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee8(params, resourceName, resourceData) {
