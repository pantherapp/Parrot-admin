...
exports.BooleanField = function (_a) {
    ...
    return (react_1.default.createElement(core_1.Typography, __assign({ component: "span", variant: "body2", className: className }, sanitizeRestProps_1.default(rest)), emptyText));
};
