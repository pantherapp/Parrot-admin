...
exports.ChipField = function (props) {
    ...
    return (react_1.default.createElement(Chip_1.default, __assign({ className: classnames_1.default(classes.chip, className), label: value }, sanitizeRestProps_1.default(rest))));
};
var EnhancedChipField = compose_1.default(pure_1.default)(exports.ChipField);
EnhancedChipField.defaultProps = {
    addLabel: true,
};
EnhancedChipField.propTypes = __assign(__assign({}, exports.ChipField.propTypes), types_1.fieldPropTypes);
