...
exports.DateField = function (_a) {
    ...
    return (react_1.default.createElement(Typography_1.default, __assign({ component: "span", variant: "body2", className: className }, sanitizeRestProps_1.default(rest)), dateString));
};
var EnhancedDateField = pure_1.default(exports.DateField);
EnhancedDateField.defaultProps = {
    addLabel: true,
};
EnhancedDateField.propTypes = __assign(__assign(__assign({}, Typography_1.default.propTypes), types_1.fieldPropTypes), { locales: prop_types_1.default.oneOfType([
...
exports.default = EnhancedDateField;
