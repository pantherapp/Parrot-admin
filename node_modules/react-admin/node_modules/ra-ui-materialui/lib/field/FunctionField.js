...
var FunctionField = function (_a) {
    ...
    return record ? (react_1.default.createElement(Typography_1.default, __assign({ component: "span", variant: "body2", className: className }, sanitizeRestProps_1.default(rest)), render(record, source))) : null;
};
var EnhancedFunctionField = pure_1.default(FunctionField);
EnhancedFunctionField.defaultProps = {
    addLabel: true,
};
EnhancedFunctionField.propTypes = __assign(__assign({}, Typography_1.default.propTypes), types_1.fieldPropTypes);
