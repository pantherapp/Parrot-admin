...
var ImageField = function (props) {
    ...
    if (!sourceValue) {
        return emptyText ? (react_1.default.createElement(Typography_1.default, __assign({ component: "span", variant: "body2", className: className }, sanitizeRestProps_1.default(rest)), emptyText)) : (react_1.default.createElement("div", __assign({ className: className }, sanitizeRestProps_1.default(rest))));
    }
