...
exports.NumberField = function (_a) {
    ...
    if (value == null) {
        return emptyText ? (react_1.default.createElement(Typography_1.default, __assign({ component: "span", variant: "body2", className: className }, sanitizeRestProps_1.default(rest)), emptyText)) : null;
    }
    return (react_1.default.createElement(Typography_1.default, __assign({ variant: "body2", component: "span", className: className }, sanitizeRestProps_1.default(rest)), hasNumberFormat ? value.toLocaleString(locales, options) : value));
};
// wat? TypeScript looses the displayName if we don't set it explicitly
exports.NumberField.displayName = 'NumberField';
var EnhancedNumberField = pure_1.default(exports.NumberField);
EnhancedNumberField.defaultProps = {
    addLabel: true,
    textAlign: 'right',
};
EnhancedNumberField.propTypes = __assign(__assign(__assign({}, Typography_1.default.propTypes), types_1.fieldPropTypes), { locales: prop_types_1.default.oneOfType([
        prop_types_1.default.string,
        prop_types_1.default.arrayOf(prop_types_1.default.string),
    ]), options: prop_types_1.default.object });
EnhancedNumberField.displayName = 'EnhancedNumberField';
exports.default = EnhancedNumberField;
