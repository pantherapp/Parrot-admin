...
exports.SelectField = function (_a) {
    ...
    return (react_1.default.createElement(Typography_1.default, __assign({ component: "span", variant: "body2", className: className }, sanitizeRestProps_1.default(rest)), choiceText));
};
...
var EnhancedSelectField = pure_1.default(exports.SelectField);
EnhancedSelectField.defaultProps = {
    addLabel: true,
};
EnhancedSelectField.propTypes = __assign(__assign(__assign({}, Typography_1.default.propTypes), types_1.fieldPropTypes), { choices: prop_types_1.default.arrayOf(prop_types_1.default.object).isRequired, optionText: prop_types_1.default.oneOfType([
