...
var TextField = function (_a) {
    ...
    if (value == null && emptyText) {
        return (react_1.default.createElement(Typography_1.default, __assign({ component: "span", variant: "body2", className: className }, sanitizeRestProps_1.default(rest)), emptyText));
    }
    return (react_1.default.createElement(Typography_1.default, __assign({ component: "span", variant: "body2", className: className }, sanitizeRestProps_1.default(rest)), typeof value !== 'string' ? JSON.stringify(value) : value));
};
...
EnhancedTextField.propTypes = __assign(__assign({}, Typography_1.default.propTypes), types_1.fieldPropTypes);
