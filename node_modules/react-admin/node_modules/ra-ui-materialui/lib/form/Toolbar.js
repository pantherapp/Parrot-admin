...
var Toolbar = function (props) {
    ...
    return (react_1.default.createElement(react_1.Fragment, null,
        react_1.default.createElement(Toolbar_1.default, __assign({ className: classnames_1.default(classes.toolbar, (_a = {},
                _a[classes.mobileToolbar] = width === 'xs',
                _a[classes.desktopToolbar] = width !== 'xs',
                _a), className), role: "toolbar" }, rest), react_1.Children.count(children) === 0 ? (react_1.default.createElement("div", { className: classes.defaultToolbar },
            react_1.default.createElement(button_1.SaveButton, { handleSubmitWithRedirect: handleSubmitWithRedirect || handleSubmit, invalid: invalid, redirect: redirect, saving: saving, submitOnEnter: submitOnEnter }),
