...
var AutocompleteArrayInput = function (props) {
    ...
    var _h = ra_core_1.useInput(__assign({ format: format, id: idOverride, input: inputOverride, meta: metaOverride, onBlur: onBlur,
        onChange: onChange,
        onFocus: onFocus,
        parse: parse,
        resource: resource,
    ...
    var _k = react_1.default.useState(''), filterValue = _k[0], setFilterValue = _k[1];
    ...
    var _l = ra_core_1.useSuggestions({
