...
var AutocompleteSuggestionItem = function (props) {
    ...
    return (react_1.default.createElement(core_1.MenuItem, __assign({ key: suggestionText, selected: isHighlighted, className: classnames_1.default(classes.root, (_a = {},
            _a[classes.selected] = isSelected,
            _a)) }, rest), react_1.isValidElement(suggestionText) ? (react_1.cloneElement(suggestionText, { filterValue: filterValue })) : (react_1.default.createElement("div", { className: classes.suggestion }, parts.map(function (part, index) {
