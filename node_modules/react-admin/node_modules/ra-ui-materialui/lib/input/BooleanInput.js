...
var BooleanInput = function (_a) {
    ...
    return (react_1.default.createElement(FormGroup_1.default, __assign({}, sanitizeRestProps_1.default(rest)),
        react_1.default.createElement(FormControlLabel_1.default, { control: react_1.default.createElement(Switch_1.default, __assign({ id: id, color: "primary", onChange: handleChange }, inputProps, options, { disabled: disabled })), label: react_1.default.createElement(ra_core_1.FieldTitle, { label: label, source: source, resource: resource, isRequired: isRequired }) }),
...
BooleanInput.propTypes = __assign(__assign({}, InputPropTypes_1.default), { options: prop_types_1.default.shape(Switch_1.default.propTypes), disabled: prop_types_1.default.bool });
