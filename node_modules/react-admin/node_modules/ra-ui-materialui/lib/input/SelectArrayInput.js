...
var SelectArrayInput = function (props) {
    ...
    return (react_1.default.createElement(core_1.FormControl, __assign({ margin: margin, className: classnames_1.default(classes.root, className), error: touched && !!error, variant: variant }, sanitizeRestProps(rest)),
        react_1.default.createElement(core_1.InputLabel, { htmlFor: id, shrink: true, variant: variant, error: touched && !!error },
        ...
        react_1.default.createElement(core_1.FormHelperText, { error: touched && !!error },
